...
class SketchService:
    ...
    def get_sketch_by_id(self, sketch_id: str | UUID) -> SongSketch | None:
        """
        Get sketch by ID
        ...
        try:
            ...
            logger.error("error_getting_sketch_by_id", sketch_id=str(sketch_id), error=str(e), error_type=type(e).__name__)
            return None
    ...
    def delete_sketch(self, sketch_id: str | UUID) -> bool:
        """
        ...
        try:
            ...
            try:
                ...
                db.rollback()
                logger.error("sketch_deletion_db_error", sketch_id=str(sketch_id), error=str(e), error_type=type(e).__name__)
                raise
            finally:
                db.close()
        except Exception as e:
    ...
    def mark_sketch_as_used(self, sketch_id: str | UUID) -> SongSketch | None:
        """
        ...
        try:
            ...
            try:
                ...
                db.rollback()
                logger.error("sketch_mark_as_used_db_error", sketch_id=str(sketch_id), error=str(e), error_type=type(e).__name__)
                raise
            finally:
                db.close()
