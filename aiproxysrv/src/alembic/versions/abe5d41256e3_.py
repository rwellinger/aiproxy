...
down_revision: Union[str, Sequence[str], None] = '28fe232c9ffd'
...
def upgrade() -> None:
    ...
    op.alter_column('generated_images', 'prompt',
               ...
               nullable=False)
    op.alter_column('project_files', 'file_size_bytes',
    ...
    op.alter_column('project_folders', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.DateTime(timezone=True),
               existing_nullable=True,
               existing_server_default=sa.text('now()'))
    ...
    op.alter_column('project_image_references', 'created_at',
    ...
    op.alter_column('release_project_references', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=True,
               existing_server_default=sa.text('now()'))
    op.drop_constraint(op.f('uq_release_project'), 'release_project_references', type_='unique')
    op.alter_column('song_projects', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.DateTime(timezone=True),
               existing_nullable=True,
               existing_server_default=sa.text('now()'))
    op.alter_column('song_projects', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.DateTime(timezone=True),
               existing_nullable=True,
               existing_server_default=sa.text('now()'))
    ...
    op.drop_index(op.f('ix_song_projects_project_name_gin'), table_name='song_projects', postgresql_ops={'project_name': 'gin_trgm_ops'}, postgresql_using='gin')
    ...
    op.alter_column('song_releases', 'updated_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=False,
               server_default=sa.text('now()'))
    op.alter_column('song_releases', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=False,
               existing_server_default=sa.text('now()'))
...
def downgrade() -> None:
    ...
    op.create_index(op.f('ix_song_projects_project_name_gin'), 'song_projects', ['project_name'], unique=False, postgresql_ops={'project_name': 'gin_trgm_ops'}, postgresql_using='gin')
    ...
    op.alter_column('song_projects', 'created_at',
               ...
               existing_nullable=True,
               existing_server_default=sa.text('now()'))
    op.create_unique_constraint(op.f('uq_release_project'), 'release_project_references', ['release_id', 'project_id'], postgresql_nulls_not_distinct=False)
    op.alter_column('release_project_references', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=False,
               existing_server_default=sa.text('now()'))
    ...
    op.create_unique_constraint(op.f('uq_project_image'), 'project_image_references', ['project_id', 'image_id'], postgresql_nulls_not_distinct=False)
    op.alter_column('project_image_references', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=False,
               existing_server_default=sa.text('now()'))
    ...
    op.alter_column('generated_images', 'prompt',
               existing_type=sa.TEXT(),
               nullable=True)
    op.create_unique_constraint(op.f('uq_provider_org_year_month'), 'api_costs_monthly', ['provider', 'organization_id', 'year', 'month'], postgresql_nulls_not_distinct=False)
    op.create_index(op.f('ix_api_costs_monthly_provider_year_month'), 'api_costs_monthly', ['provider', 'year', 'month'], unique=False)
    # ### end Alembic commands ###
